...
{	
		//GUI_ShowString(28,0,"mouerse",16,1);//英文姓名
	  GUI_ShowCHinese(0,0,16,"王宇",1);//中文姓名
		GUI_ShowChar(32,0,',',8,1);
		GUI_ShowString(42,0,"CQJTU",16,1);//数字详细

		GUI_ShowCHinese(0,15,16,"学号",1);//中文姓名
	  GUI_ShowString(32,15,"632002090830",16,1);//数字详细
